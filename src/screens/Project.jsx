...
const Project = () => {
    ...
    function addCollaborators() {
        ...
        axios.put("http://localhost:3000/projects/add-user", {
    ...
    function WriteAiMessage(message) {
        ...
        try {
            ...
            return <div className="text-red-500">Invalid AI Response</div>;
        }
    ...
    useEffect(() => {
        ...
        receiveMessage('project-message', data => {
            ...
            if (data.sender._id === 'ai') {
                try {
                    // Corrected: Parse the JSON string
                    const message = JSON.parse(data.message);

                    console.log("Parsed Message:", message);

                    // Ensure fileTree exists before calling mount
                    if (message.fileTree) {
                        webContainer?.mount(message.fileTree);
                        setFileTree(message.fileTree);
                    } else {
                        console.error("fileTree is missing in message:", message);
                    }
        ...
        axios.get(`http://localhost:3000/projects/get-project/${location.state.project._id}`).then(res => {
